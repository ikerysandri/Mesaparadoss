...
const RESTAURANTS = [
  {id:1,name:"80 Grados",visited:true,ratings:null,priceRange:null,lat:40.4245,lng:-3.7034},
  {id:2,name:"El Kiosko",visited:true,ratings:null,priceRange:null,lat:40.430,lng:-3.695},
  {id:3,name:"Grillao",visited:true,ratings:null,priceRange:null,lat:40.4168,lng:-3.7038},
  {id:4,name:"Agarimo",visited:false,ratings:null,priceRange:null,lat:40.423,lng:-3.692},
  {id:5,name:"La Maruca",visited:false,ratings:null,priceRange:null,lat:40.435,lng:-3.69},
  {id:6,name:"Hermanos Vinagre",visited:false,ratings:null,priceRange:null,lat:40.422,lng:-3.698},
  {id:7,name:"Casa Fonzo",visited:false,ratings:null,priceRange:null,lat:40.415,lng:-3.71},
  {id:8,name:"Riverita Taberna",visited:false,ratings:null,priceRange:null,lat:40.426,lng:-3.705},
  {id:9,name:"Garelos",visited:false,ratings:null,priceRange:null,lat:40.418,lng:-3.702},
  {id:10,name:"Colosimo",visited:false,ratings:null,priceRange:null,lat:40.429,lng:-3.687},
  {id:11,name:"Pimiento Verde",visited:true,ratings:null,priceRange:null,lat:40.433,lng:-3.696},
  {id:12,name:"Café Comercial",visited:false,ratings:null,priceRange:null,lat:40.428,lng:-3.706},
  {id:13,name:"Haranita",visited:false,ratings:null,priceRange:null,lat:40.419,lng:-3.703},
  {id:14,name:"El Viajero",visited:false,ratings:null,priceRange:null,lat:40.412,lng:-3.707},
  {id:15,name:"Florida Park",visited:false,ratings:null,priceRange:null,lat:40.42,lng:-3.682},
  {id:16,name:"Fratelli Figurato",visited:false,ratings:null,priceRange:null,lat:40.436,lng:-3.693},
  {id:17,name:"Manzoni",visited:false,ratings:null,priceRange:null,lat:40.431,lng:-3.694},
  {id:18,name:"Mo de Movimiento",visited:false,ratings:null,priceRange:null,lat:40.424,lng:-3.701},
  {id:19,name:"Bosco de Lobos",visited:false,ratings:null,priceRange:null,lat:40.427,lng:-3.699},
  {id:20,name:"Numa Pompilio",visited:true,ratings:null,priceRange:null,lat:40.438,lng:-3.689},
  {id:21,name:"Bibo",visited:true,ratings:null,priceRange:null,lat:40.439,lng:-3.688},
  {id:22,name:"Lobito de Mar",visited:true,ratings:null,priceRange:null,lat:40.44,lng:-3.687},
  {id:23,name:"Leña",visited:true,ratings:null,priceRange:null,lat:40.437,lng:-3.692},
  {id:24,name:"Lana",visited:false,ratings:null,priceRange:null,lat:40.416,lng:-3.709},
  {id:25,name:"Charrúa",visited:false,ratings:null,priceRange:null,lat:40.4175,lng:-3.705},
  {id:26,name:"Café de París",visited:false,ratings:null,priceRange:null,lat:40.4195,lng:-3.697},
  {id:27,name:"Taberna de Pedraza",visited:false,ratings:null,priceRange:null,lat:40.421,lng:-3.694},
  {id:28,name:"Julián de Tolosa",visited:true,ratings:null,priceRange:null,lat:40.4225,lng:-3.696},
  {id:29,name:"Piantao",visited:true,ratings:null,priceRange:null,lat:40.414,lng:-3.708},
  {id:30,name:"Las Reses",visited:false,ratings:null,priceRange:null,lat:40.4155,lng:-3.706},
  {id:31,name:"Carbón",visited:true,ratings:null,priceRange:null,lat:40.4165,lng:-3.704},
  {id:32,name:"Raza",visited:true,ratings:null,priceRange:null,lat:40.4185,lng:-3.7015},
  {id:33,name:"Morgana",visited:false,ratings:null,priceRange:null,lat:40.434,lng:-3.6945},
  {id:34,name:"Tripea",visited:false,ratings:null,priceRange:null,lat:40.413,lng:-3.7095},
  {id:35,name:"Restaurante Balear",visited:false,ratings:null,priceRange:null,lat:40.425,lng:-3.7025},
  {id:36,name:"Taberna Delfín",visited:false,ratings:null,priceRange:null,lat:40.4135,lng:-3.7085},
  {id:37,name:"Monster Sushi",visited:true,ratings:null,priceRange:null,lat:40.4345,lng:-3.6955},
  {id:38,name:"Divorare",visited:true,ratings:null,priceRange:null,lat:40.4285,lng:-3.7065},
  {id:39,name:"Haramboure",visited:false,ratings:null,priceRange:null,lat:40.4265,lng:-3.7045},
  {id:40,name:"Doña Tecla",visited:false,ratings:null,priceRange:null,lat:40.4215,lng:-3.6955},
  {id:41,name:"Café Santander",visited:true,ratings:null,priceRange:null,lat:40.4275,lng:-3.7075},
  {id:42,name:"Restaurante Tramo",visited:true,ratings:null,priceRange:null,lat:40.4305,lng:-3.6935},
  {id:43,name:"Takos al Pastor",visited:false,ratings:null,priceRange:null,lat:40.4145,lng:-3.707},
  {id:44,name:"Saku Izakaya",visited:false,ratings:null,priceRange:null,lat:40.4235,lng:-3.7005},
  {id:45,name:"Nacca",visited:false,ratings:null,priceRange:null,lat:40.4125,lng:-3.709},
  {id:46,name:"Symental",visited:false,ratings:null,priceRange:null,lat:40.4205,lng:-3.6945},
  {id:47,name:"La Vaca y la Huerta",visited:false,ratings:null,priceRange:null,lat:40.4315,lng:-3.6925},
  {id:48,name:"Asador Gonzaba",visited:false,ratings:null,priceRange:null,lat:40.417,lng:-3.7055},
  {id:49,name:"Restaurante Cardumen",visited:false,ratings:null,priceRange:null,lat:40.4255,lng:-3.703},
  {id:50,name:"Varro",visited:true,ratings:null,priceRange:null,lat:40.432,lng:-3.693},
  {id:51,name:"Toque",visited:true,ratings:null,priceRange:null,lat:40.4295,lng:-3.6865},
  {id:52,name:"Nos",visited:false,ratings:null,priceRange:null,lat:40.4355,lng:-3.691},
  {id:53,name:"La Fonda Lironda",visited:true,ratings:null,priceRange:null,lat:40.4325,lng:-3.694},
  {id:54,name:"Chez Pepito",visited:false,ratings:null,priceRange:null,lat:40.423,lng:-3.693},
  {id:55,name:"La Pagoda",visited:false,ratings:null,priceRange:null,lat:40.428,lng:-3.704},
  {id:56,name:"Pink Monkey",visited:false,ratings:null,priceRange:null,lat:40.42,lng:-3.69},
  {id:57,name:"Beata Pasta",visited:true,ratings:null,priceRange:null,lat:40.4365,lng:-3.6915},
  {id:58,name:"Josefita",visited:false,ratings:null,priceRange:null,lat:40.4245,lng:-3.7015},
  {id:59,name:"Mercado Vallehermoso (Krudo)",visited:false,ratings:null,priceRange:null,lat:40.4335,lng:-3.702},
  {id:60,name:"Ichikani",visited:true,ratings:null,priceRange:null,lat:40.4375,lng:-3.6895},
  {id:61,name:"Castelados",visited:false,ratings:null,priceRange:null,lat:40.4185,lng:-3.701},
  {id:62,name:"La Castela",visited:false,ratings:null,priceRange:null,lat:40.4175,lng:-3.6985},
  {id:63,name:"Mercado de Chamberí",visited:true,ratings:null,priceRange:null,lat:40.4355,lng:-3.7025},
  {id:64,name:"Enkai Buffet Sushi",visited:false,ratings:null,priceRange:null,lat:40.4215,lng:-3.6975},
  {id:65,name:"Revuelto",visited:false,ratings:null,priceRange:null,lat:40.429,lng:-3.708},
  {id:66,name:"Casa Orellana",visited:true,ratings:null,priceRange:null,lat:40.4175,lng:-3.6995},
  {id:67,name:"Fogata",visited:false,ratings:null,priceRange:null,lat:40.416,lng:-3.7045},
  {id:68,name:"El Enemigo",visited:false,ratings:null,priceRange:null,lat:40.415,lng:-3.7065},
  {id:69,name:"Dum Dum",visited:true,ratings:null,priceRange:null,lat:40.4165,lng:-3.6985},
  {id:70,name:"Manifesto13",visited:true,ratings:null,priceRange:null,lat:40.4225,lng:-3.7055},
  {id:71,name:"Her",visited:false,ratings:null,priceRange:null,lat:40.427,lng:-3.6905},
  {id:72,name:"Alto Bardero",visited:false,ratings:null,priceRange:null,lat:40.431,lng:-3.696},
  {id:73,name:"Olea",visited:false,ratings:null,priceRange:null,lat:40.43,lng:-3.6945},
  {id:74,name:"Ristolab",visited:false,ratings:null,priceRange:null,lat:40.424,lng:-3.7025},
  {id:75,name:"Casa Rivas",visited:false,ratings:null,priceRange:null,lat:40.4155,lng:-3.7075},
  {id:76,name:"La Notaría",visited:false,ratings:null,priceRange:null,lat:40.4195,lng:-3.6965},
  {id:77,name:"Kaito",visited:false,ratings:null,priceRange:null,lat:40.4235,lng:-3.6915},
  {id:78,name:"Yamate",visited:false,ratings:null,priceRange:null,lat:40.425,lng:-3.7},
  {id:79,name:"Casa Corea",visited:false,ratings:null,priceRange:null,lat:40.422,lng:-3.691},
  {id:80,name:"Trattoria de Alfredo",visited:false,ratings:null,priceRange:null,lat:40.4285,lng:-3.7},
  {id:81,name:"The Omar",visited:false,ratings:null,priceRange:null,lat:40.42,lng:-3.6955},
  {id:82,name:"Tetsu",visited:false,ratings:null,priceRange:null,lat:40.421,lng:-3.6935},
  {id:83,name:"Playing Solo",visited:false,ratings:null,priceRange:null,lat:40.426,lng:-3.706},
  {id:84,name:"Sacha",visited:false,ratings:null,priceRange:null,lat:40.439,lng:-3.683},
  {id:85,name:"Casa Pei",visited:false,ratings:null,priceRange:null,lat:40.4145,lng:-3.7095},
  {id:86,name:"Nakeima",visited:false,ratings:null,priceRange:null,lat:40.4185,lng:-3.7025},
  {id:87,name:"Biribiri",visited:false,ratings:null,priceRange:null,lat:40.413,lng:-3.71},
  {id:88,name:"Umaki",visited:false,ratings:null,priceRange:null,lat:40.4225,lng:-3.6945},
  {id:89,name:"Chitón",visited:false,ratings:null,priceRange:null,lat:40.4275,lng:-3.7055},
  {id:90,name:"Taquería El Puerco",visited:false,ratings:null,priceRange:null,lat:40.4135,lng:-3.711},
  {id:91,name:"Gabos",visited:false,ratings:null,priceRange:null,lat:40.433,lng:-3.697},
  {id:92,name:"Tribeca",visited:false,ratings:null,priceRange:null,lat:40.4205,lng:-3.6925},
  {id:93,name:"Tonton",visited:false,ratings:null,priceRange:null,lat:40.425,lng:-3.7045},
  {id:94,name:"Biri Biri",visited:true,ratings:null,priceRange:null,lat:40.4115,lng:-3.7085},
  {id:95,name:"Gozá",visited:false,ratings:null,priceRange:null,lat:40.4315,lng:-3.695},
  {id:96,name:"Gastón",visited:false,ratings:null,priceRange:null,lat:40.418,lng:-3.7035},
  {id:97,name:"Casa Victoria",visited:false,ratings:null,priceRange:null,lat:40.4265,lng:-3.7035},
  {id:98,name:"Hiro",visited:false,ratings:null,priceRange:null,lat:40.4215,lng:-3.6995},
  {id:99,name:"Nacha",visited:true,ratings:null,priceRange:null,lat:40.4295,lng:-3.6875},
  {id:100,name:"Caja de Cerillas",visited:false,ratings:null,priceRange:null,lat:40.4305,lng:-3.6915},
  {id:101,name:"Myo",visited:true,ratings:null,priceRange:null,lat:40.436,lng:-3.6935},
  {id:102,name:"Marciano",visited:false,ratings:null,priceRange:null,lat:40.423,lng:-3.704},
  {id:103,name:"Isa",visited:false,ratings:null,priceRange:null,lat:40.419,lng:-3.704},
  {id:104,name:"Casa Isabella",visited:false,ratings:null,priceRange:null,lat:40.4255,lng:-3.6895},
  {id:105,name:"Ancho Madrid",visited:false,ratings:null,priceRange:null,lat:40.414,lng:-3.706},
  {id:106,name:"Araia",visited:false,ratings:null,priceRange:null,lat:40.417,lng:-3.7},
  {id:107,name:"Nuga Castellana",visited:true,ratings:null,priceRange:null,lat:40.442,lng:-3.686},
  {id:108,name:"Pilar Akaneya",visited:false,ratings:null,priceRange:null,lat:40.4245,lng:-3.6905},
  {id:109,name:"Hotaru",visited:false,ratings:null,priceRange:null,lat:40.422,lng:-3.6985},
  {id:110,name:"Gaman",visited:false,ratings:null,priceRange:null,lat:40.4235,lng:-3.6975},
  {id:111,name:"Palique Pozuelo",visited:true,ratings:null,priceRange:null,lat:40.438,lng:-3.8},
  {id:112,name:"Luma",visited:false,ratings:null,priceRange:null,lat:40.4275,lng:-3.6915},
  {id:113,name:"Baro Sushi",visited:false,ratings:null,priceRange:null,lat:40.4295,lng:-3.6855},
  {id:114,name:"Nato",visited:false,ratings:null,priceRange:null,lat:40.416,lng:-3.703},
  {id:115,name:"Aredna",visited:false,ratings:null,priceRange:null,lat:40.4155,lng:-3.7015},
  {id:116,name:"Nolita Madrid",visited:false,ratings:null,priceRange:null,lat:40.432,lng:-3.696},
  {id:117,name:"Casa Mortero",visited:false,ratings:null,priceRange:null,lat:40.419,lng:-3.706},
  {id:118,name:"Casa Macareno",visited:false,ratings:null,priceRange:null,lat:40.4205,lng:-3.707},
  {id:119,name:"Güsto Mercado de San Antón",visited:true,ratings:null,priceRange:null,lat:40.4220,lng:-3.6920},
  {id:120,name:"Chirón",visited:true,ratings:null,priceRange:null,lat:40.4180,lng:-3.6980},
  {id:121,name:"Origine",visited:true,ratings:null,priceRange:null,lat:40.4260,lng:-3.7010},
  {id:122,name:"StreetXO",visited:true,ratings:null,priceRange:null,lat:40.4390,lng:-3.6870},
];
...
const CRITERIA = [
  {key:"sabor",    label:"Sabor",          icon:"😋", desc:"¿Estaba rico?", questions:[
    {q:"¿Cuánto te gustó el sabor de los platos en general?",          hint:"1 soso o malo → 10 espectacular"},
    {q:"¿Cuánto disfrutaste comiendo ahí?",                            hint:"1 no lo disfruté → 10 me encantó cada bocado"},
    {q:"¿Cuánto destacaría algún plato concreto por encima del resto?", hint:"1 nada especial → 10 plato de autor"},
  ]},
  ...
  {key:"ambiente", label:"Ambiente",       icon:"🏠", desc:"Decoración y comodidad", questions:[
    ...
    {q:"¿Cuánto te convenció el nivel de ruido para una conversación?", hint:"1 imposible hablar → 10 perfecto"},
  ...
  {key:"servicio", label:"Servicio",       icon:"🤵", desc:"Atención y tiempos", questions:[
    ...
    {q:"¿Cuánto dominio de la carta y los productos demostró el equipo?", hint:"1 no sabían nada → 10 expertos"},
  ]},
  ...
  {key:"wow",      label:"Factor Wow",     icon:"✨", desc:"Ese algo especial", questions:[
    {q:"¿Cuánto os sorprendió algún plato o momento durante la visita?", hint:"1 nada → 10 fue una revelación"},
    {q:"¿En qué medida superó vuestras expectativas previas?",          hint:"1 por debajo → 10 muy por encima"},
    {q:"¿Cuánta personalidad única tiene respecto a otros restaurantes?", hint:"1 igual que todos → 10 único en su estilo"},
  ]},
  {key:"experiencia",label:"Experiencia",  icon:"😊", desc:"¿Saliste contento?", questions:[
    ...
    {q:"¿Cuánto mejoró o empeoró tu estado de ánimo al salir?",       hint:"1 salí peor → 10 salí feliz"},
    {q:"¿Cuántas ganas te quedaron de repetir la experiencia completa?", hint:"1 ninguna → 10 quiero volver ya"},
  ]},
];

function getAvg(r) {
  if (!r) return null;
  const v = CRITERIA.map(c => r[c.key]).filter(x => x != null);
...
function RatingModal({restaurant,onSave,onClose}) {
  ...
  const [priceRange,setPriceRange]=useState(restaurant.priceRange||null);
  ...
  return (
    <Modal onClose={onClose}>
      ...
      <div style={{display:"flex",gap:10,marginTop:20}}>
        <button onClick={onClose} className="btn-o" style={{flex:1,padding:"12px",borderRadius:12,fontSize:14}}>Cancelar</button>
        <button onClick={()=>onSave(ratings,priceRange)} className="btn-g" style={{flex:2,padding:"12px",borderRadius:12,fontSize:15}}>Guardar ★</button>
      </div>
    </Modal>
  );
}
...
function AddModal({onSave,onClose}) {
  ...
  return (
    <Modal onClose={onClose}>
      ...
      <input placeholder="Nombre del restaurante" value={form.name} onChange={e=>setForm(f=>({...f,name:e.target.value}))} style={{width:"100%",padding:"12px 14px",borderRadius:10,border:"1.5px solid var(--warm)",background:"#fff",fontSize:15,marginBottom:14,color:"var(--dark)",outline:"none"}}/>
      <label style={{display:"flex",alignItems:"center",gap:10,color:"var(--text)",marginBottom:20,cursor:"pointer",fontSize:14}}><input type="checkbox" checked={form.visited} onChange={e=>setForm(f=>({...f,visited:e.target.checked}))}/>Ya lo hemos visitado — puntuar ahora</label>
      ...
      <div style={{display:"flex",gap:10,marginTop:20}}>
        <button onClick={onClose} className="btn-o" style={{flex:1,padding:"12px",borderRadius:12,fontSize:14}}>Cancelar</button>
        <button onClick={()=>{if(!form.name.trim())return;onSave({...form,ratings:form.visited?ratings:null,priceRange:form.visited?priceRange:null,id:Date.now(),lat:40.4168+(Math.random()-.5)*.04,lng:-3.7038+(Math.random()-.5)*.04});}} className="btn-g" style={{flex:2,padding:"12px",borderRadius:12,fontSize:15}}>Agregar</button>
      </div>
    </Modal>
  );
}
...
function RankCard({r,rank,onRate}) {
  ...
  const gUrl=`https://www.google.com/search?q=${encodeURIComponent(r.name+" restaurante Madrid")}`;
  ...
  return (
    <div className="card-h" style={{background:"#fff",borderRadius:14,border:"1px solid var(--warm)",overflow:"hidden"}}>
      <div style={{padding:"16px 18px",display:"flex",alignItems:"center",gap:14,position:"relative",cursor:"pointer"}} onClick={()=>setOpen(o=>!o)}>
        ...
        <div style={{flex:1}}>
          ...
          <div style={{display:"flex",flexWrap:"wrap",gap:4,alignItems:"center"}}>
            {r.priceRange&&<PriceBadge priceKey={r.priceRange}/>}
      ...
      {open&&<div style={{padding:"0 18px 16px",borderTop:"1px solid var(--cream)",display:"flex",gap:8,flexWrap:"wrap"}}>
        <button onClick={()=>window.open(gUrl,"_blank")} className="btn-g" style={{flex:1,padding:"8px",borderRadius:10,fontSize:12,fontWeight:700,border:"none",cursor:"pointer",minWidth:120}}>🔍 Google</button>
        <button onClick={()=>window.open(gmUrl,"_blank")} style={{flex:1,padding:"8px",borderRadius:10,fontSize:12,fontWeight:700,border:"none",cursor:"pointer",background:"#4285f4",color:"#fff",minWidth:120}}>📍 Google Maps</button>
        <button onClick={()=>{window.location.href=waze;setTimeout(()=>window.open(wazeFb,"_blank"),1500);}} style={{flex:1,padding:"8px",borderRadius:10,fontSize:12,fontWeight:700,border:"none",cursor:"pointer",background:"#05c8f7",color:"#1a1208",minWidth:120}}>🚗 Waze</button>
      </div>}
    </div>
  );
}

function StatsTab({rests, stats}) {
  ...
  const drillData = useMemo(() => {
    ...
    if (drill === "rated") return rests.filter(r=>r.ratings).sort((a,b)=>(parseFloat(getAvg(b.ratings))||0)-(parseFloat(getAvg(a.ratings))||0));
  ...
  return (
    <div>
      <h2 style={{fontFamily:"'Playfair Display',serif",fontSize:28,color:"var(--dark)",marginBottom:24}}>Vuestras estadísticas</h2>
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(150px,1fr))",gap:12,marginBottom:22}}>
        {[
          {key:"total",   label:"Restaurantes", value:stats.total,   icon:"🍽️", sub:"en la lista"},
          {key:"visitados",label:"Visitados",   value:stats.visited,  icon:"✅",  sub:"de aventura"},
          {key:"rated",   label:"Puntuados",    value:stats.rated,    icon:"⭐",  sub:"con nota"},
          {key:"pending", label:"Pendientes",   value:stats.pending,  icon:"⏳",  sub:"por descubrir"},
        ].map(s=>(
          <div key={s.key} onClick={()=>setDrill(drill===s.key?null:s.key)} className="card-h"
            ...
            <div style={{fontSize:26,fontWeight:800,color:drill===s.key?"var(--gold)":"var(--gold)",fontFamily:"'Playfair Display',serif",marginBottom:2}}>{s.value}</div>
            <div style={{fontSize:12,color:drill===s.key?"var(--cream)":"var(--dark)",fontWeight:600}}>{s.label}</div>
            <div style={{fontSize:11,color:drill===s.key?"#8a7a6a":"var(--muted)"}}>{drill===s.key?"▲ cerrar":"▼ ver lista"}</div>
          </div>
        ))}
        <div className="card-h" style={{background:"#fff",borderRadius:14,padding:18,textAlign:"center",border:"1px solid var(--warm)"}}>
          <div style={{fontSize:26,marginBottom:8}}>📊</div>
          <div style={{fontSize:26,fontWeight:800,color:"var(--gold)",fontFamily:"'Playfair Display',serif",marginBottom:2}}>{stats.avg}</div>
      ...
      {drill&&drillData.length>0&&(
        <div style={{position:"fixed",inset:0,background:"rgba(26,18,8,.6)",zIndex:500,display:"flex",alignItems:"flex-end",justifyContent:"center"}} onClick={()=>setDrill(null)}>
          <div style={{background:"#fff",borderRadius:"20px 20px 0 0",width:"100%",maxWidth:600,maxHeight:"80vh",display:"flex",flexDirection:"column",boxShadow:"0 -8px 40px rgba(26,18,8,.2)"}} onClick={e=>e.stopPropagation()}>
            <div style={{padding:"20px 20px 12px",display:"flex",justifyContent:"space-between",alignItems:"center",borderBottom:"1px solid var(--warm)"}}>
              ...
              <button onClick={()=>setDrill(null)} style={{background:"none",border:"none",cursor:"pointer",color:"var(--muted)",fontSize:20,lineHeight:1}}>✕</button>
            </div>
              ...
              {drillData.map(r=>{
                ...
                return (
                  <div key={r.id} style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"10px 12px",borderRadius:10,background:"var(--cream)",gap:10}}>
                    ...
                    {!avg&&r.visited&&<span style={{fontSize:11,color:"var(--muted)"}}>Sin nota</span>}
                  </div>
                );
              })}
            </div>
      ...
      {stats.top!=="Ninguno aún"&&(
        <div style={{background:"linear-gradient(135deg,var(--dark),var(--dark2))",borderRadius:16,padding:"18px 22px",marginBottom:22,display:"flex",alignItems:"center",gap:14}}>
          ...
          <div>
            <p style={{color:"var(--gold)",fontSize:10,letterSpacing:2,textTransform:"uppercase",marginBottom:3}}>Vuestro favorito hasta ahora</p>
            <p style={{fontFamily:"'Playfair Display',serif",color:"var(--cream)",fontSize:20,fontStyle:"italic"}}>{stats.top}</p>
          </div>
        </div>
      )}
      ...
      <div style={{background:"#fff",borderRadius:16,padding:22,border:"1px solid var(--warm)",marginBottom:22}}>
        ...
        {CRITERIA.map(c=>{
          const rated=rests.filter(r=>r.ratings&&r.ratings[c.key]);
          const avg=rated.length?(rated.reduce((a,r)=>a+r.ratings[c.key],0)/rated.length):0;
          return (
            <div key={c.key} style={{marginBottom:13}}>
              <div style={{display:"flex",justifyContent:"space-between",marginBottom:5}}>
                <span style={{fontSize:13,color:"var(--text)"}}>{c.icon} {c.label}</span>
                <span style={{fontWeight:700,color:"var(--gold)",fontSize:13}}>{avg?avg.toFixed(1):"—"}</span>
              </div>
              <div style={{background:"var(--warm)",borderRadius:6,height:8,overflow:"hidden"}}>
                <div style={{width:`${avg*10}%`,height:"100%",background:"linear-gradient(90deg,var(--red),var(--gold))",borderRadius:6}}/>
              </div>
            </div>
          );
        })}
      ...
      <div style={{background:"#fff",borderRadius:16,padding:22,border:"1px solid var(--warm)"}}>
        ...
        {PRICE_RANGES.map(p=>{
          const count=rests.filter(r=>r.priceRange===p.key).length;
          const total=rests.filter(r=>r.priceRange).length||1;
          return (
            <div key={p.key} style={{marginBottom:13}}>
              <div style={{display:"flex",justifyContent:"space-between",marginBottom:5}}>
                <span style={{fontSize:13,color:"var(--text)"}}>{p.emoji} {p.label}</span>
                <span style={{fontWeight:700,color:p.color,fontSize:13}}>{count}</span>
              </div>
              <div style={{background:"var(--warm)",borderRadius:6,height:8,overflow:"hidden"}}>
                <div style={{width:`${(count/total)*100}%`,height:"100%",background:p.color,borderRadius:6}}/>
              </div>
            </div>
          );
        })}
...
export default function App() {
  ...
  const saveRating=(id,ratings,priceRange)=>{setRests(rs=>rs.map(r=>r.id===id?{...r,ratings,priceRange,visited:true}:r));setTarget(null);};
  const markVisited=id=>setRests(rs=>rs.map(r=>r.id===id?{...r,visited:true}:r));
  ...
  const valorarList=useMemo(()=>{
    ...
    return {unrated:v.filter(r=>!r.ratings).sort((a,b)=>a.name.localeCompare(b.name)),rated:v.filter(r=>r.ratings).sort((a,b)=>(parseFloat(getAvg(b.ratings))||0)-(parseFloat(getAvg(a.ratings))||0))};
  },[rests]);
  ...
  const stats=useMemo(()=>{
    ...
    return {total:rests.length,visited:rests.filter(r=>r.visited).length,rated:rated.length,pending:rests.filter(r=>!r.visited).length,avg:avgs.length?(avgs.reduce((a,b)=>a+b,0)/avgs.length).toFixed(1):"—",top:[...rated].sort((a,b)=>parseFloat(getAvg(b.ratings))-parseFloat(getAvg(a.ratings)))[0]?.name||"Ninguno aún"};
  },[rests]);

  if (page==="front") return <><FontLoader/><FrontPage onEnter={()=>setPage("app")} total={rests.length} visited={rests.filter(r=>r.visited).length}/></>;

  const TABS=[{id:"ranking",label:"🏆 Ranking"},{id:"valorar",label:"⭐ Valorar"},{id:"pendientes",label:"📍 Pendientes"},{id:"stats",label:"📊 Stats"}];
      ...
      <div style={{minHeight:"100vh",background:"var(--cream)",fontFamily:"'DM Sans',sans-serif",color:"var(--text)"}}>
        ...
        <div style={{maxWidth:1000,margin:"0 auto",padding:"28px 16px"}}>
            ...
            {rankingList.length>=1&&(()=>{
              ...
              return <div style={{marginBottom:28,background:"linear-gradient(135deg,var(--dark),var(--dark2))",borderRadius:20,padding:"22px 16px",display:"flex",gap:10,justifyContent:"center",alignItems:"flex-end"}}>
                {order.map(r=>{const rk=rankingList.indexOf(r)+1;const isF=rk===1;return <div key={r.id} style={{textAlign:"center",flex:1,maxWidth:200,transform:isF?"scale(1.08)":"scale(1)"}}>
                  ...
                  {r.priceRange&&<div style={{marginTop:4}}><PriceBadge priceKey={r.priceRange}/></div>}
                </div>;})}
              </div>;
            })()}
                ...
                {showFilters&&<div style={{position:"absolute",top:"calc(100% + 6px)",right:0,background:"#fff",borderRadius:14,border:"1px solid var(--warm)",boxShadow:"0 8px 24px rgba(26,18,8,.12)",zIndex:200,padding:12,minWidth:200}}>
                  ...
                  {[{key:"avg",label:"Nota global",icon:"★"},...CRITERIA].map(c=>(
                    <button key={c.key} onClick={()=>{setSortBy(c.key);setShowFilters(false);}}
                      style={{display:"flex",alignItems:"center",gap:8,width:"100%",padding:"8px 10px",borderRadius:8,border:"none",background:sortBy===c.key?"linear-gradient(135deg,var(--gold),var(--gold-light))":""  ,color:sortBy===c.key?"var(--dark)":"var(--text)",cursor:"pointer",fontSize:13,fontWeight:sortBy===c.key?700:400,marginBottom:2,textAlign:"left"}}>
                      <span>{c.icon}</span><span>{c.label}</span>
                      {sortBy===c.key&&<span style={{marginLeft:"auto"}}>✓</span>}
                    </button>
                  ))}
                </div>}
              </div>
            ...
            {valorarList.rated.length>0&&<>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:8}}>
                {valorarList.rated.map(r=>{const a=getAvg(r.ratings);return <div key={r.id} className="card-h" style={{background:"#fff",borderRadius:12,padding:"14px 18px",border:"1px solid var(--warm)",display:"flex",alignItems:"center",justifyContent:"space-between",gap:12}}>
                  <div style={{flex:1}}><p style={{fontFamily:"'Playfair Display',serif",fontSize:15,color:"var(--dark)",marginBottom:4}}>{r.name}</p><div style={{display:"flex",flexWrap:"wrap",gap:4,alignItems:"center"}}>{r.priceRange&&<PriceBadge priceKey={r.priceRange}/>}{CRITERIA.map(c=><span key={c.key} style={{fontSize:10,color:"var(--muted)",background:"var(--cream)",padding:"1px 6px",borderRadius:6}}>{c.icon}<strong style={{color:"var(--text)"}}>{r.ratings[c.key]}</strong></span>)}</div></div>
          ...
          {tab==="pendientes"&&<div>
            ...
            <input placeholder="🔍 Buscar restaurante pendiente..." value={pendSearch} onChange={e=>setPendSearch(e.target.value)} style={{width:"100%",padding:"11px 16px",borderRadius:12,border:"1.5px solid var(--warm)",background:"#fff",fontSize:14,color:"var(--dark)",outline:"none",marginBottom:16}}/>
            <div style={{display:"flex",flexDirection:"column",gap:8}}>
              {pendList.filter(r=>r.name.toLowerCase().includes(pendSearch.toLowerCase())).map(r=><div key={r.id} className="card-h" style={{background:"#fff",borderRadius:12,padding:"14px 18px",border:"1px solid var(--warm)",display:"flex",alignItems:"center",justifyContent:"space-between",gap:12}}>
                <p style={{fontFamily:"'Playfair Display',serif",fontSize:15,color:"var(--dark)"}}>{r.name}</p>
                <button onClick={()=>{markVisited(r.id);setPendSearch("");}} className="btn-o" style={{padding:"7px 16px",borderRadius:10,fontSize:13,whiteSpace:"nowrap"}}>✅ Ya fui</button>
              </div>)}
            ...
            <div style={{position:"fixed",inset:0,background:"var(--cream)",zIndex:200,overflowY:"auto"}}>
              <div style={{maxWidth:800,margin:"0 auto",padding:"20px 16px 40px"}}>
                <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:24}}>
                  <h2 style={{fontFamily:"'Playfair Display',serif",fontSize:26,color:"var(--dark)"}}>Vuestras estadísticas</h2>
                  <button onClick={()=>setTab("ranking")} style={{background:"none",border:"1px solid var(--warm)",borderRadius:10,padding:"8px 14px",cursor:"pointer",fontSize:13,color:"var(--muted)",display:"flex",alignItems:"center",gap:6}}>✕ Cerrar</button>
                </div>
                <StatsTab rests={rests} stats={stats}/>
              </div>
            </div>
          )}
        </div>
      </div>
      {target&&<RatingModal restaurant={target} onSave={(r,p)=>saveRating(target.id,r,p)} onClose={()=>setTarget(null)}/>}
      {showAdd&&<AddModal onSave={d=>{setRests(rs=>[...rs,d]);setShowAdd(false);}} onClose={()=>setShowAdd(false)}/>}
    </>
  );
}
